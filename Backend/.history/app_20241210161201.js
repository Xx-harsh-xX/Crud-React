...
const transporter = nodemailer.createTransport({
  host: 'smtp.pristyncare.com',
  port: 587,
  secure: false,
  auth: {
    user: 'harshit.shrivastava@pristyncare.com',
    pass: 'Harsh@121',
  },
...
const mailOptions = {
  from: 'harshit.shrivastava@pristyncare.com', // Sender's email address
  to: 'harshitsinha946@gmail.com', // Receiver's email address
  subject: 'Hello World',
